...
const QuinoaSalataDetail = () => {
  ...
  const faqData = [
    {
      question: 'Kinoa yerine başka tahıl kullanabilir miyim?',
      answer: 'Evet, bulgur, kuskus veya esmer pirinç kullanabilirsiniz. Ancak kinoanın protein değeri daha yüksektir.',
    },
    {
      question: 'Bu salata kaç gün dayanır?',
      answer: 'Hava geçirmez bir kapta buzdolabında 3-4 gün saklanabilir. Avokadoyu servis öncesi eklerseniz daha taze kalır.',
    },
    {
      question: 'Vegan versiyonu nasıl yapabilirim?',
      answer: 'Beyaz peyniri çıkarıp yerine susam veya fındık ekleyebilirsiniz. Besin değeri açısından dengeli kalır.',
    },
    {
      question: 'Kinoa nasıl yıkanır?',
      answer: 'Kinoayı ince bir süzgeçte bol su altında ovarak yıkayın. Bu işlem acı tadını giderir.',
    },
  ];
...
export default QuinoaSalataDetail;