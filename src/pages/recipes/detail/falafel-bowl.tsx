...
const FalafelBowlDetail = () => {
  ...
  const recipe = {
    ...
    servings: '2 kişilik',
    difficulty: 'Orta',
    image: 'https://readdy.ai/api/search-image?query=colorful%20falafel%20buddha%20bowl%20with%20crispy%20falafel%20balls%20hummus%20quinoa%20fresh%20vegetables%20tahini%20sauce%20in%20ceramic%20bowl%20food%20photography%20natural%20lighting%20professional%20styling%20high%20resolution&width=1200&height=800&seq=recipe-falafel-bowl-hero-v2&orientation=landscape',
    description: 'Orta Doğu mutfağının vazgeçilmezi falafel ile hazırlanan doyurucu ve lezzetli bir bowl tarifi. Protein ve lif açısından zengin.',
    ingredients: [
      '1 su bardağı nohut (ıslak)',
      '1/2 soğan',
      '2 diş sarımsak',
      '1 demet maydanoz',
      '1 çay kaşığı kimyon',
    ...
    instructions: [
      'Nohutları bir gece önceden ıslak bırakın.',
      'Nohut, soğan, sarımsak ve maydanozu rondoda çekin.',
      'Baharatları ekleyip karıştırın ve 30 dk dinlendirin.',
      'Karışımdan küçük toplar yapın ve fırında 180°C\'de 25 dk pişirin.',
      'Kinoayı haşlayın ve süzün.',
      'Sebzeleri doğrayın ve bowl kasesine yerleştirin.',
      'Falafel toplarını ve kinoayı ekleyin.',
      'Tahin sosu ile servis edin.',
    ],
    nutrition: {
      calories: '420',
      protein: '18g',
    ...
    tips: [
      'Nohutları mutlaka çiğ kullanın, haşlanmış nohut ile falafel yapılmaz.',
      'Karışımı dinlendirmek çok önemli, aksi halde dağılır.',
      'Fırında pişirmek kızartmaktan daha sağlıklıdır.',
    ],
  };

  const faqData = [
    {
      question: 'Falafel neden dağılıyor?',
      answer: 'Karışımı yeterince dinlendirmediğiniz veya çok fazla su eklediğiniz için olabilir. Ayrıca nohutları haşlanmış değil çiğ kullanmalısınız.',
    },
    {
      question: 'Falafel kaç kaloridir?',
      answer: 'Bu tarif yaklaşık 420 kaloridir. Kızartma yerine fırında pişirirseniz kalori değeri daha düşük olur.',
    },
    {
      question: 'Falafel vegan mı?',
      answer: 'Evet, falafel tamamen bitkisel bir yemektir ve vegan beslenenler için mükemmel bir protein kaynağıdır.',
    },
    {
      question: 'Falafel kaç gün saklanır?',
      answer: 'Pişmiş falafel buzdolabında 3-4 gün saklanabilir. Dondurucuda ise 2-3 ay dayanır.',
    },
  ];
...
export default FalafelBowlDetail;