...
const AvokadoToastDetail = () => {
  ...
  const recipe = {
    ...
    image: 'https://readdy.ai/api/search-image?query=artisan%20avocado%20toast%20with%20perfectly%20mashed%20avocado%20cherry%20tomatoes%20microgreens%20poached%20egg%20on%20rustic%20sourdough%20bread%20white%20marble%20surface%20natural%20morning%20light%20food%20photography%20professional%20styling%20high%20resolution%20clean%20minimalist%20background&width=1200&height=800&seq=recipe-avocado-toast-hero-v2&orientation=landscape',
    description: 'Sağlıklı yağlar, protein ve lif açısından zengin, pratik ve lezzetli bir kahvaltı alternatifi. Avokado tostu enerji verir ve uzun süre tok tutar.',
    ingredients: [
      '1 dilim tam buğday ekmeği',
      '1/2 adet olgun avokado',
      '1 adet yumurta (poşe)',
      '5-6 adet cherry domates',
      'Taze roka veya mikroyeşillikler',
      '1 çay kaşığı limon suyu',
      'Tuz, karabiber',
      'Kırmızı pul biber (isteğe bağlı)',
    ],
    instructions: [
      'Ekmeği kızartın veya tost makinesinde ısıtın.',
      'Avokadoyu bir kapta ezin, limon suyu, tuz ve karabiber ekleyin.',
      'Yumurtayı poşe yapın (kaynar suda 3-4 dakika).',
      'Kızarmış ekmeğin üzerine avokado ezmesini sürün.',
      'Cherry domatesleri ikiye bölün ve avokado üzerine yerleştirin.',
      'Poşe yumurtayı üzerine koyun.',
      'Taze roka ve baharatlarla süsleyerek servis edin.',
    ],
    nutrition: {
      calories: '320',
      protein: '14g',
    ...
    tips: [
      'Avokado olgunluğunu kontrol edin, hafif yumuşak olmalı.',
      'Ekmeği fazla kızartmayın, çıtır ama yumuşak olmalı.',
      'Yumurta yerine scrambled egg da kullanabilirsiniz.',
      'Üzerine susam veya chia tohumu ekleyebilirsiniz.',
    ],
  };

  const faqData = [
    {
      question: 'Avokado nasıl seçilir?',
      answer: 'Avokado hafif bastırıldığında yumuşak olmalı ama çok yumuşak olmamalı. Koyu yeşil renkte olanlar genellikle daha olgun olur.',
    },
    {
      question: 'Yumurtasız yapabilir miyim?',
      answer: 'Evet, yumurta olmadan da yapabilirsiniz. Protein için üzerine lor peyniri veya humus ekleyebilirsiniz.',
    },
    {
      question: 'Hangi ekmek türü kullanmalıyım?',
      answer: 'Tam buğday, çavdar veya ekşi mayalı ekmek en sağlıklı seçeneklerdir. Beyaz ekmek yerine tahıllı ekmek tercih edin.',
    },
    {
      question: 'Avokado ezmeyi nasıl saklarım?',
      answer: 'Avokado ezme hava ile temas edince kararır. Hemen tüketin veya üzerine limon suyu sıkıp hava geçirmez kapta saklayın.',
    },
  ];
...
export default AvokadoToastDetail;