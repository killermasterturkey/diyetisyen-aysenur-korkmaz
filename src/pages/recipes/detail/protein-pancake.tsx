...
const ProteinPancakeDetail = () => {
  ...
  const faqData = [
    ...
    },
    {
      ...
      answer: 'Evet, yumurta yerine chia tohumu veya keten tohumu kullanabilir, süt yerine bitkisel süt tercih edebilirsiniz.',
    },
    {
      question: 'Kaç gün önceden hazırlayabilirim?',
      answer: 'Pancake\'leri pişirdikten sonra buzdolabında 2-3 gün saklayabilirsiniz. Servis öncesi hafifçe ısıtın.',
    },
    {
      question: 'Protein tozu kullanmak zorunlu mu?',
      answer: 'Hayır, protein tozu yerine 2 yumurta akı veya 2 yemek kaşığı yoğurt kullanabilirsiniz.',
    },
  ];
...
export default ProteinPancakeDetail;