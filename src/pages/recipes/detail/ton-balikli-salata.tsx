...
const TonBalikliSalataDetail = () => {
  ...
  const recipe = {
    ...
    servings: '2 kişilik',
    difficulty: 'Kolay',
    image: 'https://readdy.ai/api/search-image?query=fresh%20tuna%20salad%20bowl%20with%20mixed%20greens%20cherry%20tomatoes%20cucumber%20olives%20red%20onion%20lemon%20wedges%20on%20white%20plate%20healthy%20lunch%20food%20photography%20natural%20lighting%20professional%20styling%20high%20resolution%20clean%20background&width=1200&height=800&seq=recipe-tuna-salad-hero-v2&orientation=landscape',
    description: 'Protein ve omega-3 açısından zengin, hafif ve doyurucu bir öğle yemeği seçeneği. Ton balıklı salata, kas gelişimini destekler ve kalp sağlığına katkı sağlar.',
    ingredients: [
      '1 kutu ton balığı (suyunda)',
    ...
    instructions: [
      'Ton balığını süzün ve bir kaseye alın.',
      'Yeşillikleri yıkayın ve servis tabağına yerleştirin.',
      'Salatalık ve domatesleri doğrayın.',
      'Soğanı ince dilimleyin ve zeytinleri ekleyin.',
    ...
    tips: [
      'Ton balığını yağlı değil suyunda olanı tercih edin.',
      'Taze sebzeler kullanın, daha lezzetli olur.',
      'Salata sosu yerine zeytinyağı ve limon daha sağlıklıdır.',
      'Yanında tam buğday ekmeği ile servis edebilirsiniz.',
    ],
  };

  const faqData = [
    {
      question: 'Ton balığı sağlıklı mı?',
      answer: 'Evet, ton balığı yüksek protein ve omega-3 içerir. Ancak cıva içeriği nedeniyle haftada 2-3 porsiyon ile sınırlı tüketilmelidir.',
    },
    {
      question: 'Hangi ton balığı türünü seçmeliyim?',
      answer: 'Suyunda ton balığı, yağlı olana göre daha az kalorilidir. Alabalık ton balığı, sarı yüzgeçli tona göre daha az cıva içerir.',
    },
    {
      question: 'Bu salata kaç gün dayanır?',
      answer: 'Ton balığını ekledikten sonra aynı gün tüketilmelidir. Sebzeleri ayrı saklayıp servis öncesi karıştırabilirsiniz.',
    },
    {
      question: 'Vegan versiyonu yapılabilir mi?',
      answer: 'Evet, ton balığı yerine nohut veya tofu kullanabilirsiniz. Besin değerleri benzer olacaktır.',
    },
  ];
...
export default TonBalikliSalataDetail;